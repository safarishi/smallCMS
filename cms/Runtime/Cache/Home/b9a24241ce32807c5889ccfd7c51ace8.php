    ...
    <div class="list_main">
        ...
        <div class="list_box">
            ...
            <div class="article_list">
                <ul>
                    <!--{foreach $info as $k=>$v}-->
                    <?php if(is_array($info)): foreach($info as $key=>$a): ?><li><span><?php echo (substr($a["finishtime"],0,10)); ?></span> <a href="/Proj_05_grwz/bcms/index.php/Home/Article/articleContent/id/<?php echo ($a["id"]); ?>"><?php echo ($a["title"]); ?></a></li><?php endforeach; endif; ?>
                    <!--{/foreach}-->
