    ...
    <div id="page-head" class="clearfix">
        ...
        <div id="page-head-right">
            <div id="main-login" class="pull-right">
                ...
                <a class="twi-btn-right" name="logout" href="/0228/smallCMS/cms/index.php/Home/User/logout">
                    <span>注销</span>
                </a>
                ...
                <a class="twi-btn-left" name="login" href="/0228/smallCMS/cms/index.php/Home/User/login">
                    <span>登录</span>
                </a>
                <a class="twi-btn-right" name="register" href="/0228/smallCMS/cms/index.php/Home/User/register">
                    <span>注册</span>
                </a><?php endif; ?>

            </div>
            <div id="main-menu">
                <a href="/0228/smallCMS/cms/index.php/Home/Article/showList">网站文章</a>
    ...
    <div class="row">
        <div class="span6">
            <div class="page-header" id="more-story">
                <h3 class="title"> <span>推荐文章</span> <a href="/0228/smallCMS/cms/index.php/Home/Article/showMore"><small>更多&gt&gt</small></a> </h3>
            </div>
            <div class="row">
                ...
                <div class="span4">
                    <div class="quote">
                        ...
                        <br />
                        <a href="/0228/smallCMS/cms/index.php/Home/Article/articleContent/id/8">
            ...
            <div class="row">
                ...
                <div class="span4">
                    <div class="quote">
                        &lt;&lt;为什么总有无数的Bug困扰着程序员&gt;&gt;
                        <br />
                        <a href="/0228/smallCMS/cms/index.php/Home/Article/articleContent/id/10">
