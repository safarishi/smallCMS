    ...
    <div id="page-head" class="clearfix">
        ...
        <div id="page-head-right">
            <div id="main-menu">
                ...
                <a href="<?php echo ($smarty["const"]["/0228/smallCMS/cms/index.php/Home"]); ?>/User/leavemsg">给我留言</a>
            </div>
        </div>
    </div>
    ...
    <div class="list_main">
        ...
        <div class="list_box">
            ...
            <div class="article_list">
                <ul>
                    <!--{foreach $info as $k=>$v}-->
                    <?php if(is_array($info)): foreach($info as $key=>$a): ?><li><span><?php echo (substr($a["finishtime"],0,10)); ?></span> <a href="/0228/smallCMS/cms/index.php/Home/Article/articleContent/id/<?php echo ($a["id"]); ?>"><?php echo ($a["title"]); ?></a></li><?php endforeach; endif; ?>
                    <!--{/foreach}-->
